...
async function loadAssets() {
  ...
  try {
    ...
    //   const nameSpan = document.createElement("span");
    //   nameSpan.className = "asset-name";
    //   nameSpan.innerHTML = `<strong>${asset.name}</strong><br><span class="balance">$${asset.balance.toFixed(2)}</span>`;
    ...
    //   pieIcon.className = "icon-pie";
    //   percentDiv.appendChild(pieIcon);
    //   percentDiv.appendChild(document.createTextNode(`${Math.round(percent)}%`));
